...
def to_ssim_skimage(pred_image, gt):
    ...
    ssim_list = [metrics.structural_similarity(pred_image_list_np[ind], gt_list_np[ind], data_range=1, channel_axis=-1) for ind
...
def save_image(pred_image, image_name,  exp_name):
    ...
    for ind in range(batch_num):
        ...
        utils.save_image(pred_image_images[ind],
                         './{}_results/{}'.format( exp_name, image_name_1[:-3] + 'png'))
